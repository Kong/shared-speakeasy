...
`, meshResourceName, meshName))
	...
	skeySpec := mustParseSpec(`
		labels = {}
		depends_on = []
		data = ""
	`)
	...
	return resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: builder.AddPolicy("mesh_secret", scertName, scertResourceName, meshName, scertSpec).Build(),
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
			...
			{
				Config: builder.AddPolicy("mesh_secret", skeyName, skeyResourceName, meshName, skeySpec).Build(),
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
				...
				Config: builder.Add(mesh.AddAttribute("mtls.backends", `[
      {
        ...
        type = "provided"
    ...
    ]`).AddAttribute("mtls.enabled_backend", `"provided-1"`)).Build(),
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
			...
			{
				Config: builder.Add(mesh.RemoveAttribute("mtls")).Build(),
			},
		},
	}
}
