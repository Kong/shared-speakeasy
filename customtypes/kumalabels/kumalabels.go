...
// taken from https://github.com/kumahq/kuma/blob/3bfbb2e00d340ead83cf98265430a06a209cf2f5/pkg/core/resources/labels/registry.go#L10
...
var AllComputedLabels = map[string]func(map[string]attr.Value) bool{
	...
	"kuma.io/display-name":         alwaysAutogenerated,
	...
	"k8s.kuma.io/service-account":  alwaysAutogenerated,
	"kuma.io/workload":             alwaysAutogenerated,
	"kuma.io/listener-zoneingress": alwaysAutogenerated,
	"kuma.io/listener-zoneegress":  alwaysAutogenerated,
	"kuma.io/sidecar-injection": func(labels map[string]attr.Value) bool {
		// Autogenerated when k8s.kuma.io/namespace is "kong-mesh-system"
		if nsVal, ok := labels["k8s.kuma.io/namespace"]; ok {
			if strVal, ok := nsVal.(basetypes.StringValue); ok && !strVal.IsNull() && !strVal.IsUnknown() {
				return strVal.ValueString() == "kong-mesh-system"
			}
		}
		return false
	},
